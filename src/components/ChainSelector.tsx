  ...
  return (
    <DropdownMenu open={open} onOpenChange={setOpen}>
      <DropdownMenuTrigger asChild>
        <button
          className={cn(
            "w-full flex items-center justify-between gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg",
        ...
        >
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-background flex items-center justify-center overflow-hidden">
              <img
            ...
            <div className="text-left">
              <p className="font-semibold text-foreground text-sm sm:text-base">{selectedChain.name}</p>
              <p className="text-[10px] sm:text-xs text-muted-foreground">Chain ID: {selectedChain.id}</p>
            </div>
          </div>
          <ChevronDown
            className={cn(
      ...
      >
        {chains.map((chain) => (
          <DropdownMenuItem
            ...
            className={cn(
              "flex items-center gap-2 sm:gap-3 p-2 sm:p-3 cursor-pointer",
          ...
          >
            ...
            <div className="flex-1">
              <p className="font-medium text-foreground text-sm sm:text-base">{chain.name}</p>
              <p className="text-[10px] sm:text-xs text-muted-foreground">{chain.shortName}</p>
            </div>
